...
public class Ex05_JRaidio_ItemListener extends JFrame implements ActionListener, ItemListener {
	JPanel jp1, jp2;
	...
	public Ex05_JRaidio_ItemListener() {
		super("라디오 버튼");
		jp1 = new JPanel();
