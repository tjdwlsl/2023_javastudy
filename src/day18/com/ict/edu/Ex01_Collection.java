...
//	//		보통은 리턴을 받지 않는다.(set에서는 중복 검사시 리턴을 받아서 활용할 수 있다.)
//	
...
//	//		=> 인자로 들어온 객체가 포함되어 있으면 true를 반환한다.
//	
//	//	isEmpty() : boolean
//	//		=> 해당 컬렉션이 비어 있으면 true를 반환한다.
//	
//	// **
//	//	iterator() : Iterator<E>
//	//		=> 컬렉셕 안에 존재하는 객체들을 순서대로 접근하기 위해서 Iterator 객체를 반환한다.
//	//		 요소들을 하나씩 꺼내서 작업할 때  사용 (for문도 사용 가능)
//	
//	//	remove(Object o) : boolean
//	//		=> 인자로 들어온 객체를 삭제, 성공하면 true
//	
//	//	size() : int
//	//		=> 컬렉션 안에 존재하는 요소의 수 (for문 사용할 때 활용할 수 있다.)
//	
//	//	toArray() : Objectp[]
//	//		=> 컬렉션을 배열로 만든다.
