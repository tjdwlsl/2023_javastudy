...
public class Ex07_LocalDate {
	public static void main(String[] args) {
		...
		System.out.println("getYear() : " + cDate.getMonth()); 			  //May
		System.out.println("getMonthValue() : " + cDate.getMonthValue()); //월(1,2,3..)
		System.out.println("getDayOfYear() : " + cDate.getDayOfYear());   //년의 몇번째 일(얼마나지났는지)
		System.out.println("getDayMonth() : " + cDate.getDayOfMonth());   //일
		...
		//1970년 1월 1일 UTC의 첫 번째 순간 이후희 현재 시간까지의 나노초를 나타는 값
		...
		LocalDate eDate = LocalDate.of(2023, 06, 20);
