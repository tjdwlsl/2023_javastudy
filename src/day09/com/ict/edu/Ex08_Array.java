...
public class Ex08_Array {
	...
	public static void main(String[] args) {
		//다차원 배열 : 1차원뱅별이 여러개 모인것
		//더차원 배열의 종류 : 기본자료형과 참조자료형
		//고정길이배열,가변길이배열(디자인배열에만 존재)
		
		//고정길이 배열
		//1. 선언 : 자료합[][]
		int su[][];
		
		//2. 생산 : 이름 = new 자료형[1차원 배열의 수 ][1차원 배열 안에 존재하는 배열의 크기]
		su = new int[2][3]; //1차원배열의 2개이고 각 각 3개의 배열을 가지고 있다.
